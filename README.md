...
A frontend-only Netflix Clone built using HTML, CSS, and JavaScript.
This project recreates the look and feel of the Netflix homepage, including navigation, hero banner, trending slider, FAQ accordion, and feature sections.
